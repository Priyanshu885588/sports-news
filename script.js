...
document.addEventListener("DOMContentLoaded", () => {
  ...
  darkBtn.addEventListener('click', () => {
    ...
    const backColor = getComputedStyle(document.documentElement).getPropertyValue('--back-color').trim();
    ...
    if (primaryColor === 'rgb(255, 255, 255)') {
      ...
      document.documentElement.style.setProperty('--primary-color-light', 'rgba(0, 0, 0, 0.28)');
    } else {
      ...
      document.documentElement.style.setProperty('--primary-color-light', 'rgba(255, 255, 255, 0.28)');
    }
  });
});
